...
import com.spring.projectboard.dto.request.ArticleRequest;
import com.spring.projectboard.dto.response.ArticleResponse;
import com.spring.projectboard.dto.response.ArticleWithCommentsResponse;
...
public class ArticleController {
    ...
    public String postNewArticle(ArticleRequest articleRequest) {
        ...
        articleService.saveArticle(articleRequest.toDto(UserAccountDto.of(
                "moon", "asdf1234", "moon@mail.com", "moon", "memo"
        )));
